...
L<Rethinkdb::Base> is a simple base class.
...
L<Rethinkdb::Base> exports the following functions if imported with the C<-base>
...
L<Rethinkdb::Base> implements the following methods.
...
L<Mojo::Base>, L<Mojolicious>, L<http://mojolicio.us>.
